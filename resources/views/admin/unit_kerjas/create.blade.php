                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h2 class="mb-0 fw-bold">Tambah Unit Kerja Baru</h2>
                                <small class="text-muted">Silakan lengkapi formulir berikut untuk menambahkan unit kerja
                                    baru.</small>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-light d-flex justify-content-between align-items-center">
                    <h5 class="mb-0 fw-bold text-dark">
                        <i class="ti ti-building me-2"></i>Tambah Unit Kerja
                    </h5>
                </div>
                <div class="card-body p-4">
                    <form action="{{ route('admin.unit-kerjas.store') }}" method="POST">
                        @csrf
