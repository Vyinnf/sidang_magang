                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h2 class="mb-0 fw-bold">Edit Pengguna</h2>
                                <small class="text-muted">Perbarui informasi pengguna berikut sesuai kebutuhan.</small>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-light d-flex justify-content-between align-items-center">
                    <h5 class="mb-0 fw-bold text-dark">
                        <i class="ti ti-user me-2"></i>Edit Pengguna
                    </h5>
                </div>
                <div class="card-body p-4">
                    <form action="{{ route('admin.users.update', $user->id) }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="form-label" for="password">Password <small>(kosongkan jika tidak ingin
                                        diubah)</small></label>
                                ...
                                <select class="form-select @error('unit_kerja_id') is-invalid @enderror" id="unit_kerja_id"
                                    ...
                                    @foreach ($unitKerjas as $unitKerja)
                                        <option value="{{ $unitKerja->id }}"
                                            {{ old('unit_kerja_id', $user->unit_kerja_id) == $unitKerja->id ? 'selected' : '' }}>
