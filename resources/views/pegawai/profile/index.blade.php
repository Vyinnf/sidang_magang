                ...
                <div class="col-lg-4 mb-4">
                    <div class="card border-0 shadow-sm">
                        <div class="card-body text-center p-4">
                            ...
                            <!-- Action -->
                            <div class="mt-4">
                                <a href="{{ route('pegawai.profile.edit') }}" class="btn btn-sm btn-primary me-2">
                    ...
                    <div class="card border-0 shadow-sm mb-4">
                        <div class="card-header bg-light">
                            <h5 class="mb-0 fw-bold text-dark">
                                <i class="ti ti-user-check me-2"></i>Informasi Personal
                            </h5>
                        </div>
                        <div class="card-body">
                            <div class="row g-3">
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <p class="fw-semibold mb-0">
                                        {{ $user->pegawai->skCpnsPppk->tmt ? $user->pegawai->skCpnsPppk->tmt->format('d F Y') : '-' }}
                                    </p>
                                </div>
                                <div class="col-md-6">
