                        ...
                        <x-slot name="actions">
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li><a class="dropdown-item" href="{{ route('operator.permohonan-sk.export', array_merge(request()->query(), ['format' => 'excel'])) }}">Excel</a></li>
                                    <li><a class="dropdown-item" href="{{ route('operator.permohonan-sk.export', array_merge(request()->query(), ['format' => 'pdf'])) }}">PDF</a></li>
                                </ul>
                            </div>
                        ...
                        <table class="table table-hover align-middle">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th>
                                        Nama Pegawai
                                        <a href="{{ route('operator.permohonan-sk.index', array_merge($currentQuery, ['sort' => 'id', 'dir' => 'asc'])) }}" class="text-muted ms-1">
                                            <i class="ti ti-arrow-up f-12"></i>
                                        </a>
                                        <a href="{{ route('operator.permohonan-sk.index', array_merge($currentQuery, ['sort' => 'id', 'dir' => 'desc'])) }}" class="text-muted ms-1">
                                            <i class="ti ti-arrow-down f-12"></i>
                                        </a>
                                    </th>
                                    <th class="text-center">
                                        Tanggal Pengajuan
                                        <a href="{{ route('operator.permohonan-sk.index', array_merge($currentQuery, ['sort' => 'tanggal_pengajuan', 'dir' => 'asc'])) }}" class="text-muted ms-1">
                                            <i class="ti ti-arrow-up f-12"></i>
                                        </a>
                                        <a href="{{ route('operator.permohonan-sk.index', array_merge($currentQuery, ['sort' => 'tanggal_pengajuan', 'dir' => 'desc'])) }}" class="text-muted ms-1">
                                            <i class="ti ti-arrow-down f-12"></i>
                                        </a>
                                    </th>
                                    <th class="text-center">
                                        Status
                                        <a href="{{ route('operator.permohonan-sk.index', array_merge($currentQuery, ['sort' => 'status', 'dir' => 'asc'])) }}" class="text-muted ms-1">
                                            <i class="ti ti-arrow-up f-12"></i>
                                        </a>
                                        <a href="{{ route('operator.permohonan-sk.index', array_merge($currentQuery, ['sort' => 'status', 'dir' => 'desc'])) }}" class="text-muted ms-1">
                                            <i class="ti ti-arrow-down f-12"></i>
                                        </a>
                                    </th>
